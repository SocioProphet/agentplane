...
This consumes either a full Prophet Platform event-capability bundle or the
flattened records emitted by:

  python specs/orchestration/event_capability_fixture.py --events

AgentPlane's rule is strict: events can propose work, but admission must prove
